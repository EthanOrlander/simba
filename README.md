...
1. Set environment veriables in .env

2. `pnpm install`

3. pnpm docker:local:up

4. `pnpm db:push`
- If you run into any issues here, you're probably running postgres elsewhere & need to kill or rename it.
